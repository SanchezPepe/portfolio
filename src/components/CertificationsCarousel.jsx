          ...
          return (
            ...
            >
              <div className="flex items-center gap-3">
                <div className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-full ${cert.iconBgColor} ${cert.iconColor} shadow-sm group-hover:scale-110 transition-transform`}>
